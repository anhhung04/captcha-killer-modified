...
print(
    "Welcome to captcha-killer-modified server script, project address: https://github.com/f0ng/captcha-killer-modified\nFor Linglong Security vulnerability mining training and learning, contact WeChat: f-f0ng Note: Linglong Security Training\n\n")
